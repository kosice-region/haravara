                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                          width: 60.w,
                          height: 60.h,
                          child: Image.asset('assets/company-logo/KSK_logo_hor_ver.png',fit:BoxFit.contain)
                      ),
                      Container(
                        width: 100.w,
                        height: 100.h,
                        child: Image.asset('assets/company-logo/KRT_bw_sk-removebg.png',fit:BoxFit.contain,), 
                      ),
                      Container(
                        width: 40.w,
                        height: 40.h,
                        child: Image.asset(imageAssets[4],fit:BoxFit.contain,), 
                      ),
