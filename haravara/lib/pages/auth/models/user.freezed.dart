...
class _$UserImpl with DiagnosticableTreeMixin implements _User {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(id: $id, username: $username, email: $email, phoneNumber: $phoneNumber, phones: $phones, userProfile: $userProfile, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
class _$UserProfileImpl with DiagnosticableTreeMixin implements _UserProfile {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserProfile(avatar: $avatar, profileType: $profileType, children: $children, location: $location)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, avatar, profileType, children, location);
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      ...
      @JsonKey(name: 'children') final int? children,
      @JsonKey(name: 'location') final String? location}) = _$UserProfileImpl;
